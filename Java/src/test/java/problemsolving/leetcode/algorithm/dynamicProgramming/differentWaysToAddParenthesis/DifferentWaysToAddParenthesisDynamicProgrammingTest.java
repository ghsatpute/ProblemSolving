...
class DifferentWaysToAddParenthesisDynamicProgrammingTest {
    @Test
    public void testCase01() {
        String token = "1+2";
        List<Integer> output = new DifferentWaysToAddParenthesisDynamicProgramming().diffWaysToCompute(token);
