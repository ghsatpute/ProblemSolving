...
class BestTimeToBuyAndSellStockWithCoolDownBruteForceSimplifiedTest {
    @Test
    public void testCase01() {
        int[] input = new int[] {1, 2, 3, 0, 2};

        int output = new BestTimeToBuyAndSellStockWithCoolDownBruteForceSimplified().maxProfit(input);
